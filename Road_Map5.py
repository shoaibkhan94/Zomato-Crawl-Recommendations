...
def main():
    ...
    path = "E:\ZomatoCrawl\Tomato_db_sorted.csv"
    #My Location : 22.587212, 88.374389
    gmaps = googlemaps.Client(key='AIzaSyCjTjiBfYyUzHQDr8-PIO5KF3XvVu6wNjo')
    my_loc = (22.567729,88.373510)#22.587212, 88.374389)
